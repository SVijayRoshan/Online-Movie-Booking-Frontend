...
const mockMovies: Movie[] = [
  // English movies
  {
    ...
    duration: 148,
    genres: ['English', 'Sci-Fi', 'Thriller'],
    rating: 8.8,
    shows: [],
  },
  {
  ...
  // Anime movies
  {
    ...
    posterUrl: 'https://upload.wikimedia.org/wikipedia/en/3/30/Spirited_Away_poster.JPG',
    duration: 125,
  ...
  },
  {
    ...
    synopsis: 'Tanjiro and the Demon Slayer Corps embark on a new mission aboard the Mugen Train.',
    posterUrl: 'https://upload.wikimedia.org/wikipedia/en/2/2f/Demon_Slayer_-_Kimetsu_no_Yaiba_-_The_Movie_Mugen_Train_poster.png',
    duration: 117,
  ...
  },
  {
    ...
    synopsis: 'A young warrior becomes embroiled in a struggle between forest gods and humans.',
    posterUrl: 'https://upload.wikimedia.org/wikipedia/en/7/7e/Princess_Mononoke_Japanese_poster.png',
    duration: 134,
    genres: ['Anime', 'Fantasy', 'Adventure'],
    rating: 8.4,
    shows: [],
  },
  {
    ...
    posterUrl: 'https://upload.wikimedia.org/wikipedia/en/5/5d/Akira_%281988_poster%29.jpg',
    duration: 124,
  ...
  },
  {
    ...
    posterUrl: 'https://upload.wikimedia.org/wikipedia/en/7/7b/One_Piece_Film_Red_poster.jpg',
    duration: 115,
